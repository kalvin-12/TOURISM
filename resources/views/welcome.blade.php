    ...
    <nav>
      <div class="layout">
        <div class="logo">
          ...
          <a href=""><img src="{{ asset('css/asset/logo-black.png')}}" class="black" /></a>
        </div>
    ...
    <div class="layar-penuh">
      <header id="home">
        ...
        <video autoplay muted loop>
          <source src="{{asset('css/asset/myVideo.mp4')}}" type="video/mp4" />
        </video>
        <div class="intro">
      ...
      <div class="isi">
        <div class="isi-satu">
          <a href=""
            ><img src="{{asset('css/asset')}}/icon-event.png" alt="" />
            <br />
            <h6>Event</h6></a
          >
          <a href=""
            ><img src="{{asset('css/asset')}}/icon-maps.png" alt="" />
            <br />
            <h6>Peta</h6></a
          >
          <a href=""
            ><img src="{{asset('css/asset')}}/icon-culinary.png" alt="" />
            <br />
            <h6>Kuliner</h6></a
          >
          <a href=""
            ><img src="{{asset('css/asset')}}/icon-shopping.png" alt="" />
            <br />
            <h6>Shopping</h6></a
          >
        </div>
        <div class="isi-satu">
          <a href=""
            ><img src="{{asset('css/asset')}}/icon-outdoornature.png" alt="" />
            <br />
            <h6>Outdoor</h6></a
          >
          <a href=""
            ><img src="{{asset('css/asset')}}/icon-hotel.png" alt="" />
            <br />
            <h6>Hotel</h6></a
          >
          <a href=""
            ><img src="{{asset('css/asset')}}/icon-heritage.png" alt="" />
            <br />
            <h6>Heritage</h6></a
          >
          <a href=""
            ><img src="{{asset('css/asset')}}/icon-faq.png" alt="" />
            <br />
            <h6>FAQ</h6></a
          >
        </div>
              ...
              <div class="row">
                ...
                <div class="col-4">
                  <div class="text-right">
                    <img
                      src="{{asset('css/asset')}}/icon-360.png"
              ...
              <div class="row">
                <div class="col-md-12 text-center">
                  <div class="container_video_overlay">
                    ...
                    >
                      <source src="{{asset('css/asset')}}/Wisata.mp4" type="video/mp4" />
                    </video>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="text-center">
                    <img src="{{asset('css/asset')}}/icon-sign.png" alt="" />
                  ...
                  <div class="row">
                    <div class="col-md-12 my-4">
                      <a class="text-dark w-100">
                        ...
                        >
                          <div class="img-hover">
                            <img
                              src="{{asset('css/asset')}}/Gedung.jpg"
                    ...
                    <div class="col-md-12 my-4">
                      ...
                      >
                        <div class="img-hover">
                          <img
                            src="{{asset('css/asset')}}/Piala Walikota.png"
